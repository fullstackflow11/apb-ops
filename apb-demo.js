...
(async function () {
  ...
  var MAP = {
    ...
    "apb-pto.html":        { area: "Time-off requests", supabase: true, liveSrc: "Supabase", need: "Saved to this browser only — goes company-wide once connected to the shared database." },
    "apb-tasks.html":      { area: "Task board", supabase: true, liveSrc: "Supabase", need: "Saved to this browser only — goes company-wide once connected to the shared database." },
    "apb-status.html":     { area: "Field status updates", supabase: true, liveSrc: "Supabase", need: "Posts + photos save to this browser for now; they'll save under each project in SharePoint/Supabase when connected (this replaces the per-project Teams chat)." },
