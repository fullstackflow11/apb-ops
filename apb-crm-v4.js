...
window.switchMainTab=switchMainTab; window.openLeadModal=openLeadModal; window.closeLeadModal=closeLeadModal; window.saveLead=saveLead; window.deleteLead=deleteLead; window.showLeadDetail=showLeadDetail; window.openJobModal=openJobModal; window.closeJobModal=closeJobModal; window.saveJob=saveJob; window.deleteJob=deleteJob; window.showJobDetail=showJobDetail; window.closeDetail=closeDetail; window.toggleFolder=toggleFolder; window.handleFileSelect=handleFileSelect; window.clearFile=clearFile;
